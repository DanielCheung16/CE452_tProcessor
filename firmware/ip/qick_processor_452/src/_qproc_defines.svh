...
`ifndef DEFINES
   ...
   typedef struct packed {
      ...
      bit         r_wave_we ; //waveform register write enable
      bit [6:0]   addr  ;     //destination register address
      bit [1:0]   src  ;      //choose the data write back to register(from ALU,DMEM,another ALU, Literal)  
      bit         port_re ;   
      } CTRL_REG;
